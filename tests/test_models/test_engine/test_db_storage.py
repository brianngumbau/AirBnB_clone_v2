...
class TestDBStorage(unittest.TestCase):
    ...
    def test_new(self):
        ...
        new = User(
            email='brianngumbau9075@gmail.com',
            password='password',
            first_name='Brian',
            last_name='Ngumbau'
        )
        ...
        self.assertIn('brianngumbau9075@gmail.com', result)
        self.assertIn('password', result)
        self.assertIn('Brian', result)
        self.assertIn('Ngumbau', result)
        cursor.close()
        dbc.close()
